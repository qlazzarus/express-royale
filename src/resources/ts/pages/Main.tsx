...
const TransferMenu = () => {
    ...
    return (
        <div className="bg-gray-900 rounded w-full md:w-1/2 px-8 pt-6 pb-8 mx-auto my-8">
            <Link to={Path.TRANSFER} className={'inline-block w-full text-center bg-red-500 hover:bg-red-700 text-white my-2 py-2 px-4 rounded focus:outline-none focus:shadow-outline'}>
                {t('MENU_TRANSFER')}
            </Link>
